  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 88 }}>
      <div style={{ position: "relative", overflow: "hidden" }}>
        <img src="/hero.png" style={{ width: "100%", height: 240, objectFit: "cover", objectPosition: "center bottom", display: "block" }} />
      ...
      <div style={ padding: "22px 16px 0" }>
        <div style={ fontSize: 12, color: C.muted, marginBottom: 12, fontWeight: 500 }>POWERPLANT STORE</div>
        <a href="https://store.ohou.se/brands/9626?affect_id=1345922&affect_type=ProductSaleDetail&query=%ED%8C%8C%EC%9B%8C%ED%94%8C%EB%9E%9C%ED%8A%B8" target="_blank" style={ display: "block", borderRadius: 14, overflow: "hidden", textDecoration: "none" }>
          <img src="/banner.jpg" style={ width: "100%", display: "block", borderRadius: 14 } />
        </a>
      </div>
    </div>
  );
